...
class _HomeScreenState extends State<HomeScreen> {
  ...
  //  Future<void> fetchDiseaseSol() async {
  //   // Fetch disease description
  //   fertilizer = await apiService.getFertilizer(diseaseName: diseaseName);
  //   setState(() { });
  //   print(fertilizer);
  //   // Fetch disease causes
  // }
  // Future<void> fetchDiseaseInfo() async{
  //   diseaseCauses = await apiService.getCause(diseaseName: diseaseName);
  //   setState(() {});
  // }
  ...
  Future<void> showSolutionWidget() async {
    ...
    // Fetch fertilizer, nutrients, and management
  }
